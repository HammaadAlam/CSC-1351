...
public class Prog01_aOrderedList {
	 ...
	 * 
	 * getInputFile - Gets the input file from user and checks if it exists
	 * @UserPrompt - Input file
	 ...
	 * 
	 * getOutputFile - Gets the output file from user and checks if it is valid
